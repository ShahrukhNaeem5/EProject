                                    ...
                                    <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                                        <div class="p-4 border-top">
                                            ...
                                            if (isset($_POST['btnAdd'])) {
                                                ...
                                                $strtolower = strtolower(pathinfo($_FILES['pimage']['name'], PATHINFO_EXTENSION));

                                                if (in_array($strtolower, $accept)) {
                                                    $blobimage = addslashes(file_get_contents($_FILES['pimage']['tmp_name']));
                                                    move_uploaded_file($img_tmp_name, "images/" . $img_name);
                                                }

                                                $sql = "INSERT INTO product_add1 (Product_Name,Manufacturer_Brand,Fprice,Dprice,PCategory,Product_des,Product_Pic)

                                              Values ('$name','$Manu_Brand','$Fpri','$Dpri','$Categ','$P_Desc','$blobimage')";

                                                if ($conn->query($sql) === TRUE) {
                                                    echo "<h2><b>Product has been Added!</b></h2>";
                                                } else {
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="productname" name="txtName" placeholder="Enter Product Name" type="text" class="form-control">
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="manufacturerbrand" name="Mbrand" placeholder="Enter Manufacturer Brand" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">

                                                        <div class="mb-3">
                                                            <label class="form-label" for="manufacturerbrand">Full Price</label>
                                                            <input id="manufacturerbrand" name="Fprice" placeholder="Enter Full Price" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="price">Discount Price</label>
                                                            <input id="price" name="Dprice" placeholder="Enter Dscount Price" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" data-trigger id="choices-single-default" name="cat" id="">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $row['Service_Id']; ?>"><?php echo $row['category']; ?></option>
                                                                <?php }
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <textarea name="Desc" class="form-control" id="productdesc" placeholder="Enter Description" rows="4"></textarea>
                                                </div>
                                                <br>
                                                <div class="col-lg-4">
                                                        <div class="mb-3">
                                                ...
                                                <br>
                                                <input name="btnAdd" class="btn btn-success" type="submit" value="Add Product">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="" target="_blank">Beauty First</a>
                            </div>
                        </div>
                    </div>
                </div>
