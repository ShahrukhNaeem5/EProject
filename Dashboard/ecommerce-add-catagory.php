                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-16 mb-1">Catagories Info</h5>
                                                        <p class="text-muted text-truncate mb-0">Add Your Catagories</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
...
$subname= $_POST['Sub-category'];
$manubrand= $_POST['Manufacturer_Brand'];



$sql ="INSERT INTO category( category , Sub_category, Manufacturer_Brand )

Values ('$cataname','$subname','$manubrand')";

if ($conn->query($sql) === TRUE)
{
echo"<h2><b>Category Added!</b></h2>";
}
else
{
...
?>
                                             <form method="post">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="productname">Catagory</label>
                                                        <input id="productname" name="category" placeholder="Enter Product Name" type="text" class="form-control">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            
                                                            <div class="mb-3">
                                                                <label class="form-label" for="manufacturername">Sub-Catagory</label>
                                                                <input id="manufacturername" name="Sub-category" placeholder="Enter Manufacturer Name" type="text" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="manufacturerbrand" name="Manufacturer_Brand" placeholder="Enter Manufacturer Brand" type="text" class="form-control">
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input  name="btnAdd" value="Save"  type="submit" class="btn btn-success">
                                                            </div>
