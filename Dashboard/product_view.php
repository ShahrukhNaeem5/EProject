                    ...
                    <div class="topnav">
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-toggle arrow-none" href="layout-vertical-dark.php" id="topnav-dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
$query="SELECT * FROM `product_add1`";
...
?><br><br>
<a href="ecommerce-add-product.php" class="btn btn-success">Add Products </a>
<br><br>
...
<th>Product_des</th> 
<th>Main Product_Pic</th>

<th>ProductImage_1 </th> 
<th>ProductImage_2</th>
<th>ProductImage_3</th>
<th>ProductImage_4</th>
<th>ProductImage_5</th>
...
<td><?php echo $row['Manufacturer_Brand']; ?></td>
<td><?php echo $row['Fprice']; ?></td>
<td><?php echo $row['Dprice']; ?></td>
<td><?php echo $row['PCategory']; ?></td>
<td><?php echo $row['Product_des']; ?></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="Product"></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>" alt="Product"></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Image2']);?>" alt="Product"></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Image3']);?>" alt="Product"></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Image4']);?>" alt="Product"></td>
<td ><img width="100px" height="100px" class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Image5']);?>" alt="Product"></td>

<td>
    
<a href="Product_Delete.php?Id=<?php echo $row['Id']; ?>" class="btn btn-danger">Delete Product</a>
</td>
