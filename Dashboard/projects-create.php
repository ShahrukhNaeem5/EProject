...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Create New Project | Vuesy - Admin & Dashboard Template</title>
...
$Squery = "UPDATE `project_info` SET `Name`= '$name',`Description`= '$des',`location`= '$loc',`Num`= '$num',`email`= '$email' WHERE `id`='1'";



/* $Squery="UPDATE `sservice` SET `Service_Name `='$name',`Service_Fees`='$fees' WHERE `Service_Id`='$id' ";
 */
                                                ...
                                                <form method="post">
                                                    <div>
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="projectname" value="<?php echo $row[1]; ?>" type="text" name="txtName" class="form-control" placeholder="Enter Project Name">
                                                        </div>
   
                                                        <div class="mb-3">
                                                            <label for="projectdesc" class="form-label">Project Description</label>
                                                           
                                                            <textarea name="txtdes" class="form-control" id="projectdesc" rows="3" placeholder="Enter Project Description..."><?php echo $row[1]; ?></textarea>
                                                        </div>
                                                       
                                                        <div class="mb-3">
                                                            <label class="form-label">Location</label>
                                                            <input value="<?php echo $row[3]; ?>" type="text" name="txtloc"  class="form-control" placeholder="Enter Your Location..." id="">
                                                        </div>  
                                                       
                                                        <div class="mb-3">
                                                            <label class="form-label">Phone</label>
                                                            <input value="<?php echo $row[4]; ?>" name="txtnum" type="number" class="form-control" placeholder="Enter Your Number..." id="">
                                                        </div>  
                                                    </div>
                                                    <div class="mb-3">
                                                            <label class="form-label">Email</label>
                                                            <input value="<?php echo $row[5]; ?>" name="txtemail" type="text" class="form-control" placeholder="Enter Your Email..." id="">
                                                        </div>  
                                                        <div class="d-flex align-items-start gap-3 mt-4">
                                                <input type="submit" name="btnUpdate" value="Submit" class="btn btn-primary w-sm">
