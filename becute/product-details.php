...
<head>
  <meta charset="utf-8">
  <title>Becute - Product Details</title>
...
<body>
    ...
    <!-- End preloader -->
      ...
      <header class="header__section">
        ...
        include('connect.php');
        $id=$_GET['id'];
        $squery="SELECT * FROM `product_add1` WHERE `Id`='$id'";
        ...
        <div class="offCanvas__minicart">
            <div class="minicart__header ">
                ...
                <p class="minicart__header--desc">ertertert<?php echo $row['Product_Name'];?></p>
            </div>
    ...
    <main class="main__content_wrapper">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>"><img class="product__media--preview__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>"><img class="product__media--preview__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="data:image/jpg;base64,<?php echo base64_encode($row['image2']);?>"><img class="product__media--preview__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['image2']);?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="data:image/jpg;base64,<?php echo base64_encode($row['image2']);?>" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="data:image/jpg;base64,<?php echo base64_encode($row['image3']);?>"><img class="product__media--preview__items--img" src="assets/img/product/big-product/product4.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="data:image/jpg;base64,<?php echo base64_encode($row['image3']);?>" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="data:image/jpg;base64,<?php echo base64_encode($row['image4']);?>"><img class="product__media--preview__items--img" src="assets/img/product/big-product/product5.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                            ...
                            <div class="single__product--nav swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <img src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="Category">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['image2']);?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['image3']);?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="data:image/jpg;base64,<?php echo base64_encode($row['image4']);?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="product__section section--padding ">
            <div class="container">
                ...
                <div class="product__section position-relative">
                            ...
                            <div class="swiper-slide">
                                <article class="product__card">
                                    <div class="product__card--thumbnail">
                                        <a class="product__card--thumbnail__link display-block" href="product-details.php?id=<?php echo $row['Id'];?>">
                                    ...
                                    <div class="product__card--content text-center">
                                        ...
                                        <h3 class="product__card--title"><a href="product-details.php?id=<?php echo $row['Id'];?>"><?php echo $row['Product_Name'];?></a></h3>
