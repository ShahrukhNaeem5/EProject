                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="c_details.php?id=<?php echo $row['Service_Id']; ?>">
...
?>
                                    ...
                                    <li class="widget__categories--menu__list">
                                    <a href="c_details.php?id=<?php echo $row['Service_Id']; ?>">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="data:image/jpg;base64,<?php echo base64_encode($row['picture']);?>" alt="categories-img">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="shop__sidebar--product">
                                    ...
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.php?id=<?php echo $row['Id'];?>">
                                            <img src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="product">
                                            </a>
                                        </div>
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.php?id=<?php echo $row['Id'];?>"><?php echo $row['Product_Name'];?> </a></h3>
                                            <div class="small__product--card__price mb_5">
                            ...
                            <div class="tab_content">
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner">
                                        ...
                                        <?php
$id=$_GET['id'];
$squery="SELECT * FROM `product_add1` JOIN `category` on product_add1.PCategory = category.Service_Id WHERE PCategory='$id';
";
$sresult=mysqli_query($conn,$squery);
if(!$sresult)
{
                                                ...
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php?id=<?php echo $row['Id'];?>">
                                                             ...
                                                             <img class="product__card--thumbnail__img product__primary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="product-img"> 
                                                             <img class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>" alt="product-img">
                                                        </a>
