                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            ...
                            <li class="header__menu--items">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link active" href="contact.php">Contact </a>  
                                </li>
                            </ul>
                        </nav>
                    </div>
...
$sql ="INSERT INTO contact_us (FName, LName, PNum, Email,Msg)

Values ('$name','$names','$No','$emails','$txt')";

if ($conn->query($sql) === TRUE)
{
echo"<h2><b>Thanks For Contact Us!</b></h2>";
}
else
{
...
?>
                        <form class="contact__form--inner" method="post" action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="Fname" id="input2" placeholder="Your Last Name" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="num" id="input3" placeholder="Phone number" type="number">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="mail" id="input4" placeholder="Email" type="email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        <label class="contact__form--label" for="input5">Write Your Message <span class="contact__form--label__star">*</span></label>
                                        <textarea class="contact__form--textarea" name="sms" id="input5" placeholder="Write Your Message"></textarea>
                                    </div>
                                </div>
                            </div>
                            <button class="contact__form--btn primary__btn" name="btnAdd" type="submit"> <span>Submit Now</span></button>  
                        </form>
                    </div>
                    <?php    
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Change the design through a range <br> <a href="tel:+01234-567890"><?php echo $row[4]; ?></a>   </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> <a href="mailto:beauty@example.com"><?php echo $row[5]; ?></a> </p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
