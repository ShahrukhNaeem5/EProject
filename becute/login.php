...
<head>
  <meta charset="utf-8">
  <title>Becute - Account Page</title>
  ...
  if (isset($_POST['username']))
   {
      ...
      if ($rows == 1) {
          ...
          header("Location: http:shop.php");
      } else {
          echo "<div class='form'>
                <h3>Incorrect Username/password.</h3><br/>
                <p class='link'>Click here to <a href='login.php'>Login</a> again.</p>
                <p class='link'>Click here to <a href='register.php'>Register First if you not registered </a> </p>
                </div>";
      }
  } else {
?>
                            ...
                            <div class="col">
                                <div class="account__login register">
                                    <div class="account__login--header mb-25">
                                        ...
                                        <h2 class="account__login--header__title mb-15">Log In Here</h2>
                                        <p class="account__login--header__desc"><a href="register.php"> Register here</a> if you are a new customer</p>
                                    </div>
                                    <div class="account__login--inner">
                                        <label>
                                        <input name="username" type="text" class="account__login--input"  placeholder="User Name">
                                            
                                        </label>
                                       
                                        <label>
                                        <input name="password" type="password" class="account__login--input"  placeholder="Enter Password">
                                        ...
                                        <button class="account__login--btn primary__btn mb-10" type="submit" name="submit">Log In</button>
